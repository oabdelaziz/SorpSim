 ...
 * QGraphicsItem children when it is destroyed.
 */
...
public:
    ...
    /// \name Heat and mass transfer variables for liquid desiccant units.
    ///
    /// \{
    ...
    /// \name Calculated results
    ///
    /// \{
    float htr;      ///< Heat rate
    int ipinchr;    ///< Unused
                    ///< \todo delete or set from results
    ...
    /// \name Parametric table mode inputs
    ///
    ...
    ///
    /// \{
    int ihtT;         ///< \todo unused -- because why let user control this in the table?
    float htT;        ///< See ht
    int ipinchT;      ///< See ipinch
    int icopT;        ///< See icop
    double NTUmT;     ///< See NTUm
    double NTUtT;     ///< See NTUt
    double NTUaT;     ///< See NTUa
    double wetnessT;  ///< See wetness
    double leT;       ///< See le
    /// \}

    /// \name Parametric table mode outputs from calculation.
    ///
    /// \{
    ...
    /// \name Graph structure, state point nodes, and graphics text
    ///
    /// \{
